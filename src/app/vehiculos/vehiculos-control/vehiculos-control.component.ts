...
@Component({
  selector: 'app-vehiculos-control',
  template: `
  ...
  styleUrls: ['./vehiculos-control.component.scss']
})
export class VehiculosControlComponent implements OnInit {
...
// data recibida del crud
 ...
 openForm(modo: string, item: any) {
   {
     const modalRef = this.modalService.open(VehiculosFormComponent,
       {
         // scrollable: false,
